            ...
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    @enderror
                  <input type="text" name="name_product" id="name_product" placeholder="Enter name product" autocomplete="name_product" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <select class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" name="category_id" id="category_id">
                        @foreach($suppliers as $supplier)
                            <option value="{{ $supplier->id }}">{{ $supplier->name_people }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-span-6 sm:col-span-3">
                    @error('quantity')
                        <div class="text-blue-600">{{ $message }}</div>
                    @enderror
                  <input type="number" name="quantity" id="quantity" placeholder="Enter Quantity...." autocomplete="email" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
                ...
                <div class="col-span-6">
                    ...
                    <div class="mb-3 xl:w-96">
                        <textarea class=" form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                              focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="description_prod" name="description_prod" rows="3" placeholder="Your description...."></textarea>
                    </div>
                </div>
