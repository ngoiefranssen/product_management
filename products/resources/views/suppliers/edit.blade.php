              ...
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    @error('country_suppplier')
                         <div class="text-blue-600">{{ $message }}</div>
                    @enderror
                  <input type="text" value="{{ $supplier->country_supplier }}" name="country_supplier" id="country_suppplier" placeholder="Enter country......." autocomplete="country_suppplier" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
